...
async def get_user_videos_analytics(user_name):
    ...
    try:
        ...
        dist_chart_like = get_dis_chart(cleaned_data, 'Likes')
        dist_chart_comment = get_dis_chart(cleaned_data, 'Comments')
        dist_chart_share = get_dis_chart(cleaned_data, 'Shares')
        dist_chart_save = get_dis_chart(cleaned_data, 'Saves')   
